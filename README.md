...
1. 下载 [Radwater-ADV-v0.4.4.bin](firmware/Radwater-ADV-v0.4.4.bin)。校验信息见 [固件清单](firmware/README.md)。
...
**升级先备份 `/PocketFishing/`。** 更名后保留原存档路径，v0.4.0、v0.4.1 与 v0.4.4 互相兼容；v0.3.0 及更早固件不支持新增的 v3 记录，回退需升级前副本。[完整安装与存档说明](docs/PLAYING.md)
...
v0.4.0 已由作者在 ADV 上安装并反馈观感良好；v0.4.4 完成开场动画、同源渲染与自动化验证。小字、按键手感、音频、SD 突然断电与续航仍需要更多实际测试。
