...
d.text((24,12),'RADWATER / 余波 · v0.4.2',font=font,fill='#e9ddbc')
...
for name in ['fish.png','screens.png','specimens.png','objects.png','lore.png','features.png','gameplay.gif']:
    ...
    (root/'dist'/f'{source.stem}-v0.4.2{source.suffix}').write_bytes(source.read_bytes())
...
od.text((24,10),'坐会儿吧 / v0.4.2 · 240×135 同源渲染',font=font,fill='#e9ddbc')
